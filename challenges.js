...
//define a function
//create a variable to store tally
// iterate through the array either with forloop or forEach
//return final value
...
-----------------------------------------------------------------------------*/
// Your solution for 05-computeRemainder: (HELP)
let computeRemainder = (dividend, divisor) => {
...
//   if (str === "") return "";
//   else return reverseUpcaseString(str.substr(1)) + str.charAt(0).toUpperCase();
// }
// 2. Reverse a String With Built-In Functions (chain three methods)
function reverseUpcaseString(str) {
...
function findHighestPriced(arr){
  return arr.reduce((highest,each) => each.price > highest.price ? each : highest)
}
